...
Writes to `frontend/src/data/combinedResults.json` so the frontend can
...
OUT = REPO_ROOT / "frontend" / "src" / "data" / "combinedResults.json"
OUT_PUBLIC = REPO_ROOT / "frontend" / "public" / "combinedResults.json"
...
def main():
    ...
    detailed_path = REPO_ROOT / "frontend" / "public" / "combinedResultsDetailed.json"
